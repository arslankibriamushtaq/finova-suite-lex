...
const sullisCash: ModuleLocale = {
  ...
  en: {
    ...
    "loans.subtitle":
      "Every cash advance taken, with its live payoff and the terms it was priced at.",
    "loans.search": "Search loan number…",
    "loans.filter.title": "Filters",
    "loans.filter.clear": "Clear filters",
    "loans.filter.currency": "Currency",
    "loans.filter.allCurrencies": "All currencies",
    "loans.filter.status": "Status",
    "loans.filter.allStatuses": "All statuses",
    "loans.filter.walletId": "Wallet ID",
    "loans.filter.walletIdPlaceholder": "Every loan taken by one wallet",
    "loans.col.loanNumber": "Loan #",
    "loans.col.currency": "Currency",
    "loans.col.principal": "Principal",
    "loans.col.profit": "Profit",
    "loans.col.totalDue": "Total due",
    "loans.col.payoff": "Payoff today",
    "loans.col.disbursed": "Disbursed",
    "loans.col.due": "Due",
    "loans.col.status": "Status",
    "loans.col.action": "Action",
    "loans.overdueDays": "{{count}} day overdue",
    "loans.overdueDays_other": "{{count}} days overdue",
    "loans.stats.totalLoans": "{{count}} loan",
    "loans.stats.totalLoans_other": "{{count}} loans",
    "loans.stats.active": "Active",
    "loans.stats.overdue": "Overdue",
    "loans.stats.disbursed": "Ever lent",
    "loans.detail.title": "Loan {{loanNumber}}",
    "loans.detail.status": "Status",
    "loans.detail.penalty": "Penalty",
    "loans.detail.settled": "Settled amount",
    "loans.detail.tenure": "Tenure (days)",
    "loans.detail.overdueDays": "Overdue days",
    "loans.detail.dailyProfitRate": "Daily profit rate",
    "loans.detail.penaltyDailyRate": "Penalty daily rate",
    "loans.detail.penaltyGraceDays": "Penalty grace days",
    "loans.detail.repaidAt": "Repaid at",
    "loans.detail.snapshotNote":
      "These rates are the loan's own snapshot, taken at disbursement. Changing the product's terms never re-prices a loan a customer already took.",
    "loans.detail.wallet": "Borrowing wallet",
    "loans.detail.walletNumber": "Wallet number",
    "loans.detail.customerId": "Customer ID",
    "loans.detail.customerName": "Customer",
    "loans.detail.walletStatus": "Wallet status",
    "loans.detail.walletPurged":
      "This wallet has been purged, so only its ID remains. The loan itself is never hidden.",
    "loans.toast.loadFailed": "Failed to load loans",
    "loans.toast.statsFailed": "Failed to load loan totals",
    "loans.toast.detailFailed": "Failed to load the loan",
    "cfg.subtitle":
    ...
    "cfg.toast.saved": "{{currency}} terms saved",
  ...
  fr: {
    ...
    "loans.subtitle":
      "Chaque avance accordée, son solde de rachat actuel et les conditions appliquées.",
    "loans.search": "Rechercher un numéro de prêt…",
    "loans.filter.title": "Filtres",
    "loans.filter.clear": "Effacer les filtres",
    "loans.filter.currency": "Devise",
    "loans.filter.allCurrencies": "Toutes les devises",
    "loans.filter.status": "Statut",
    "loans.filter.allStatuses": "Tous les statuts",
    "loans.filter.walletId": "ID du portefeuille",
    "loans.filter.walletIdPlaceholder": "Tous les prêts d'un portefeuille",
    "loans.col.loanNumber": "N° de prêt",
    "loans.col.currency": "Devise",
    "loans.col.principal": "Principal",
    "loans.col.profit": "Bénéfice",
    "loans.col.totalDue": "Total dû",
    "loans.col.payoff": "Rachat aujourd'hui",
    "loans.col.disbursed": "Décaissé",
    "loans.col.due": "Échéance",
    "loans.col.status": "Statut",
    "loans.col.action": "Action",
    "loans.overdueDays": "{{count}} jour de retard",
    "loans.overdueDays_other": "{{count}} jours de retard",
    "loans.stats.totalLoans": "{{count}} prêt",
    "loans.stats.totalLoans_other": "{{count}} prêts",
    "loans.stats.active": "Actifs",
    "loans.stats.overdue": "En retard",
    "loans.stats.disbursed": "Total prêté",
    "loans.detail.title": "Prêt {{loanNumber}}",
    "loans.detail.status": "Statut",
    "loans.detail.penalty": "Pénalité",
    "loans.detail.settled": "Montant réglé",
    "loans.detail.tenure": "Durée (jours)",
    "loans.detail.overdueDays": "Jours de retard",
    "loans.detail.dailyProfitRate": "Taux de bénéfice journalier",
    "loans.detail.penaltyDailyRate": "Taux de pénalité journalier",
    "loans.detail.penaltyGraceDays": "Jours de grâce",
    "loans.detail.repaidAt": "Remboursé le",
    "loans.detail.snapshotNote":
      "Ces taux sont ceux figés au décaissement. Modifier les conditions du produit ne retarife jamais un prêt déjà accordé.",
    "loans.detail.wallet": "Portefeuille emprunteur",
    "loans.detail.walletNumber": "N° de portefeuille",
    "loans.detail.customerId": "ID client",
    "loans.detail.customerName": "Client",
    "loans.detail.walletStatus": "Statut du portefeuille",
    "loans.detail.walletPurged":
      "Ce portefeuille a été purgé : seul son identifiant subsiste. Le prêt reste toujours visible.",
    "loans.toast.loadFailed": "Échec du chargement des prêts",
    "loans.toast.statsFailed": "Échec du chargement des totaux",
    "loans.toast.detailFailed": "Échec du chargement du prêt",
    "cfg.subtitle":
    ...
    "cfg.toast.saved": "Conditions {{currency}} enregistrées",
  ...
  ar: {
    ...
    "loans.subtitle": "كل سلفة نقدية مع مبلغ سدادها الحالي والشروط التي سُعّرت بها.",
    "loans.search": "ابحث برقم التمويل…",
    "loans.filter.title": "عوامل التصفية",
    "loans.filter.clear": "مسح عوامل التصفية",
    "loans.filter.currency": "العملة",
    "loans.filter.allCurrencies": "كل العملات",
    "loans.filter.status": "الحالة",
    "loans.filter.allStatuses": "كل الحالات",
    "loans.filter.walletId": "معرّف المحفظة",
    "loans.filter.walletIdPlaceholder": "كل تمويلات محفظة واحدة",
    "loans.col.loanNumber": "رقم التمويل",
    "loans.col.currency": "العملة",
    "loans.col.principal": "أصل المبلغ",
    "loans.col.profit": "الربح",
    "loans.col.totalDue": "إجمالي المستحق",
    "loans.col.payoff": "السداد اليوم",
    "loans.col.disbursed": "تاريخ الصرف",
    "loans.col.due": "تاريخ الاستحقاق",
    "loans.col.status": "الحالة",
    "loans.col.action": "إجراء",
    "loans.overdueDays": "متأخر {{count}} يوم",
    "loans.overdueDays_other": "متأخر {{count}} يومًا",
    "loans.stats.totalLoans": "{{count}} تمويل",
    "loans.stats.totalLoans_other": "{{count}} تمويلًا",
    "loans.stats.active": "نشط",
    "loans.stats.overdue": "متأخر",
    "loans.stats.disbursed": "إجمالي ما صُرف",
    "loans.detail.title": "التمويل {{loanNumber}}",
    "loans.detail.status": "الحالة",
    "loans.detail.penalty": "الغرامة",
    "loans.detail.settled": "المبلغ المسدَّد",
    "loans.detail.tenure": "المدة (أيام)",
    "loans.detail.overdueDays": "أيام التأخر",
    "loans.detail.dailyProfitRate": "معدل الربح اليومي",
    "loans.detail.penaltyDailyRate": "معدل الغرامة اليومي",
    "loans.detail.penaltyGraceDays": "أيام السماح",
    "loans.detail.repaidAt": "تاريخ السداد",
    "loans.detail.snapshotNote":
      "هذه المعدلات مثبّتة وقت الصرف. تغيير شروط المنتج لا يعيد تسعير تمويل حصل عليه العميل بالفعل.",
    "loans.detail.wallet": "المحفظة المقترضة",
    "loans.detail.walletNumber": "رقم المحفظة",
    "loans.detail.customerId": "معرّف العميل",
    "loans.detail.customerName": "العميل",
    "loans.detail.walletStatus": "حالة المحفظة",
    "loans.detail.walletPurged": "حُذفت هذه المحفظة ولم يبقَ سوى معرّفها. ولا يُخفى التمويل أبدًا.",
    "loans.toast.loadFailed": "تعذر تحميل التمويلات",
    "loans.toast.statsFailed": "تعذر تحميل الإجماليات",
    "loans.toast.detailFailed": "تعذر تحميل التمويل",
    "cfg.subtitle":
    ...
    "cfg.toast.saved": "تم حفظ شروط {{currency}}",
