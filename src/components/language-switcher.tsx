        ...
        <button type="button" className="lang-switch-btn" aria-label="Change language">
          ...
          <style>{`
            ...
            .lang-switch-btn:hover {
              ...
              border-color: var(--color-action, #10b981);
            ...
            .lang-switch-btn[data-state="open"] { border-color: var(--color-action, #10b981); }
            .lang-switch-globe { color: var(--color-action, #10b981); }
            ...
            .lang-switch-badge {
              ...
              flex-shrink: 0;
              background: color-mix(in srgb, var(--color-action, #10b981) 12%, transparent);
            ...
            .lang-switch-check { color: var(--color-action, #10b981); flex-shrink: 0; }
            .lang-switch-item.is-active {
              background: color-mix(in srgb, var(--color-action, #10b981) 9%, transparent);
            }
            .lang-switch-item.is-active .lang-switch-badge {
              background: var(--color-action, #10b981);
              color: #ffffff;
            }
          `}</style>
        </button>
