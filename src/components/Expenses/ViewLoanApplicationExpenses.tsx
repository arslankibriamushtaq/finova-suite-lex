...
import { GetLoanApprovalExpensesByNationalId } from "../../redux/apis/apisCrudLms";
import TableView from "../TableView/TableView";
import toast from "react-hot-toast";
import Loader from "../Loader/Loader";

const LoanApplicationExpenseDetail = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await GetLoanApprovalExpensesByNationalId(payload);
...
export default LoanApplicationExpenseDetail;
