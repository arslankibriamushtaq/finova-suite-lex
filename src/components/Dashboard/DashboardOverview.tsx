  ...
  const statsData: StatCard[] = [
    {
      ...
      value:loading?<PulseLoader/>:applicationData?.total_loan_applications,
      image: AntDesignIcon,
      activeClass: "active3",
    ...
    },
    {
      ...
      value:loading?<PulseLoader/>:applicationData?.completed_applications,
      image: FileInvoiIcon,
    },
    {
      title: "Total In Progress Applications",
      value:loading?<PulseLoader/>:applicationData?.in_progress_applications,
      image: FileIcon,
      link: "/LOS/FinancingApplications/InProgressFinancing",
    },
    {
      title: "Total Approved Applications",
      value:loading?<PulseLoader/>:applicationData?.approved_applications,
      image: FileInIcon,
      link: "/LOS/FinancingApplications/ApprovedFinancing",
    },
    {
      title: "Total Rejected Applications",
      value:loading?<PulseLoader/>:applicationData?.rejected_applications,
    ...
    },
    {
      ...
      value:loading?<PulseLoader/>:applicationData?.today_completed_applications || 0,
      image: FileInIcon,
    },
    {
      title: "Total Disbursed Amount",
      value:loading?<PulseLoader/>:applicationData?.total_disbursed_amount,
      image: FileInvoi1Icon,
    },
    {
      title: "Total Customers",
      value:loading?<PulseLoader/>:applicationData?.total_customers,
      image: FileMinusIcon,
      activeClass: "active4",
