...
import {
  ...
  getAllCanceledFinancingApplications,
...
const CanceledFinancing = () => {
  ...
  const getLeadsList = async () => {
    try {
      setSkelitonLoading(true);
      const response = await getAllCanceledFinancingApplications(page, pageSize);
...
export default CanceledFinancing;
