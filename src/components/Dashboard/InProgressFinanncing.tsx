...
import {
  ...
  getAllInProgressFinancingApplications,
...
const InProgressFinancing = () => {
  ...
  const getLeadsList = async () => {
    try {
      setSkelitonLoading(true);
      const response = await getAllInProgressFinancingApplications(page, pageSize);
...
export default InProgressFinancing;
