...
const ApprovedRescheduledApplications = () => {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Approved Rescheduled Applications");
    XLSX.writeFile(workbook, "Approved_Rescheduled_Applications.xlsx");
  };
...
export default ApprovedRescheduledApplications;
