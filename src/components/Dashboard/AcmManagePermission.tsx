...
const AcmManagePermission: React.FC = () => {
  ...
  setSelectedSubOptions((prevSelectedSubOptions: any) => {
    ...
    if (!createAssignPermission) {
      // Add all permissionIds that aren't already in existingPermissions
      ...
      // If no permissions remain, remove the module key entirely
...
export default AcmManagePermission;
