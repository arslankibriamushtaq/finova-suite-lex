  ...
  const renderStepper = () => {
    ...
    return (
      <Card bordered={false} style={{ ...styles.card, padding: "24px" }}>
        ...
        <Card bordered style={{ borderRadius: 2, borderColor: "var(--border)" }}>
      ...
      <div style={{ padding: "20px", background: "var(--background)" }}>
        ...
        {complianceQuestionHistory.map((entry: any, entryIndex: number) => {
          ...
          return (
            <div
              key={entryIndex}
              style={{ marginBottom: "30px", padding: "20px", background: "var(--muted)", borderRadius: "2px" }}
            >
  ...
  const renderRiskHistory = () => {
    ...
    return (
      <div style={{ padding: "20px", background: "var(--background)" }}>
        ...
        {/* Current Risk Info */}
        {hasRiskInfo && (
          <div style={{ marginBottom: "20px", padding: "20px", background: "var(--muted)", borderRadius: "2px" }}>
            <Row gutter={24}>
              <Col xs={24} md={12}>
                <div style={styles.fieldRow}>
                  <span style={styles.label}>KYC ID</span>
        ...
        {hasRiskCalculation && (
          <div style={{ marginBottom: "20px", padding: "20px", background: "var(--muted)", borderRadius: "2px" }}>
            ...
            {riskCalculation.formula && (
              <div style={{ marginTop: "12px", padding: "12px", background: "var(--background)", borderRadius: "2px", fontSize: "13px", color: "var(--muted-foreground)", wordBreak: "break-all" }}>
        ...
        {hasRiskHistory && riskHistory.map((assessment: any, index: number) => (
          <div
            ...
            style={{ marginBottom: "20px", padding: "20px", background: "var(--muted)", borderRadius: "2px" }}
          >
            <h6 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "15px", color: "var(--foreground)" }}>
              Assessment #{index + 1}
            </h6>
      ...
      { name: "Type", selector: (row: any) => row.type || "--" },
      {
        ...
        cell: (row: any) => {
          ...
          const statusColor =
            ...
            "var(--color-warning)";
          return (
            <span style={{ padding: "4px 10px", borderRadius: "2px", fontSize: "12px", backgroundColor: statusColor, color: "white" }}>
              {status}
            </span>
          );
        },
