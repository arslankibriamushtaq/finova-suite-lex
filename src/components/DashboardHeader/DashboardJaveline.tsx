  ...
  const numbersBarChartOptions = {
        ...
        series: [
          ...
          },
          {
            ...
            barCategoryGap: "0%", // No gap between bars in the same category
            itemStyle: {
              color: "#EDC7C9", // Color for the second set of bars
            },
          },
        ],
        tooltip: {
  ...
  const numbersBarChartOptions2 = {
    ...
    series: [
      
      {
        ...
        barCategoryGap: "0%", // No gap between bars in the same category
        itemStyle: {
          color: "#AB1920", // Color for the second set of bars
        },
      },
      {
  ...
  <Tabs
    ...
    <div className="dash-onboarding javalin-center-board col-12 gap-3">
      ...
      <div className="col-md-12" style={{padding:"0px"}}>
          ...
          <div className="user-detail-bg" style={{backgroundColor:"#E1F4FF", borderRadius:"2px" }}>
          </div>
        </div>
