...
const OptionalReasonRescheduling = () => {
  ...
  const Activity_Loans_Header = [
    {
      name: t("optionalReasonRescheduling.col.title"),
    ...
    {
      name: t("optionalReasonRescheduling.col.factorWeight"),
      selector: (row: { factor_weight: any }) => row.factor_weight ?? "-",
    },
    {
      name: t("optionalReasonRescheduling.col.factors"),
  ...
  const getList = async (searchQuery?: string) => {
    ...
    try {
      const res = await getLOVsByType("OptionalReasonRescheduling", page, pageSize, searchQuery || searchTerm);
      if (res) {
      ...
      console.error("Error fetching Optional Reason Rescheduling:", error);
      setSkelitonLoading(false);
    }
  };
...
export default OptionalReasonRescheduling;
