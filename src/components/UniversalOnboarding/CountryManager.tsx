      ...
      <div className="flex justify-between items-end mb-10">
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="bg-slate-50 border border-slate-200 rounded-xl ps-10 pe-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all w-72"
          />
        </div>
      </div>
