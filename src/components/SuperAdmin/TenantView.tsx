...
const TenantView = () => {
  ...
  const [activeTab, setActiveTab] = useState("TenantDetails");
  const [heading, setHeading] = useState("Tenant Details");
    ...
    <>
      <div className="tenant-detail-container">
        ...
        <div className="d-flex align-items-center gap-2 mb-3">
          ...
          <h3 className="fs-6 fw-600 mb-0">Tenants Details</h3>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            <Tab eventKey="TenantDetails" title="Tenant Details">
              <div className="p-4">
                <h5 className="fs-6 fw-600 mb-3"> Tenant Details</h5>
            ...
            <Tab eventKey="Tenant Products" title="Tenant Products">
            ...
            <Tab eventKey="Tenant Modules" title="Tenant Modules">
