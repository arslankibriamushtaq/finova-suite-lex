...
const OppurtunitiesView = () => {
  ...
  const [activeTab, setActiveTab] = useState("OppurtunitiesDetails");
  const [heading, setHeading] = useState("Oppurtunities Details");
  ...
  const handleSelect = (key: any) => {
    setActiveTab(key);
    switch (key) {
      case "OppurtunitiesDetails":
        setHeading("Oppurtunities Details");
        break;
      ...
      cell: (row: any) => (
        <div>
          <Switch
            ...
            height={24} // Adjust the height of the switch
            width={48}
            boxShadow="#fff"
          />
        </div>
    ...
    <>
      <div className="tenant-detail-container">
        ...
        <div className="d-flex align-items-center gap-2 mb-3">
          ...
          <h3 className="fs-6 fw-600 mb-0">Oppurtunities Details</h3>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            <Tab eventKey="OppurtunitiesDetails" title="Oppurtunities Details">
              <div className="p-4">
                <h5 className="fs-6 fw-600 mb-3">Oppurtunities Details</h5>
                ...
                <div className="row mt-5 d-flex flex-wrap">
                  ...
                  <h4 className="fs-6 fw-600 mb-2">4. PaymentDetails</h4>
                  {tenantViewFields.map((field, index) => (
                    <div className="col-md-4 mt-1 mb-1" key={index}>
                      <div
                        className="d-flex justify-content-between align-items-center w-100 p-3"
            ...
            <Tab
              eventKey="OppurtunitiesProducts"
              title="Oppurtunities Products"
            >
              <div className="cs-table p-2">
                <h4 className="fs-6 fw-600 mt-3 mb-3">Selected Products</h4>
                <TableView
                  setPage={setPage}
            ...
            <Tab eventKey="OppurtunitiesModule" title="Oppurtunities Module">
...
export default OppurtunitiesView;
