...
const OppurtunititesTenant = () => {
  ...
  const handleView = (row: any) => {
    ...
    setEditFormData({ ...row });
    navigate(`/view/oppurtunities/${row.CustomerID}`);
  };
  ...
  return (
    <>
      ...
      <h2 className="d-flex align-items-center col-12 justify-content-between fs-6 ps-3 mb-3 mt-4">Oppurtunities</h2>
...
export default OppurtunititesTenant;
