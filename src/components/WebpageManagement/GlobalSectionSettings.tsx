                      ...
                      <div key={fieldName}>
                        ...
                        <div style={{ marginLeft: '15px', borderLeft: '2px solid var(--color-border-light)', paddingLeft: '10px' }}>
                          {Array.isArray(fieldValue) && fieldValue.map((nestedItem: any, nestedIndex: number) => (
                            <div key={nestedIndex} style={{ marginBottom: '10px', padding: '8px', backgroundColor: 'var(--background)', borderRadius: '2px' }}>
          ...
          <div style={{
            ...
            <div style={{ marginTop: '20px', display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
              <button
                ...
                style={{ padding: '10px 20px', border: '1px solid var(--color-border-light)', borderRadius: '2px', cursor: 'pointer' }}
              >
                Cancel
              </button>
              <button
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '20px' }}>
              {(() => {
                ...
                if (editingRepeaterField === 'social_links') {
                  ...
                  return (
                    <div style={{ border: '1px solid var(--color-border-light)', padding: '15px', borderRadius: '2px' }}>
                      {/* URL Field */}
                      {groupFields.url && (
            ...
            <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
              <button onClick={handleRepeaterModalCancel} style={{ padding: '10px 20px', border: '1px solid var(--color-border-light)', borderRadius: '2px', cursor: 'pointer' }}>
                Cancel
              </button>
              <button onClick={handleRepeaterModalSave} style={{ padding: '10px 20px', backgroundColor: 'var(--color-action-blue)', color: 'var(--primary-foreground)', border: 'none', borderRadius: '2px', cursor: 'pointer' }}>
                Save
              </button>
            </div>
          </div>
