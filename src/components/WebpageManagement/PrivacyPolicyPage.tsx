...
import PrivacyPolicy from '../WebPages/PrivacyPolicy'; // Import from WebPages folder
...
const PrivacyPolicyManagement: React.FC = () => {
  ...
  const handleEditClick = () => {
    navigate('/Los/WebPageManagement/PrivacyPolicyTemplatePage/Settings');
  };
  ...
  return (
    ...
    >
      ...
      {/* Render the actual PrivacyPolicy component */}
      <PrivacyPolicy />
    </div>
  );
};
