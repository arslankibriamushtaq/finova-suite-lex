  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "data-[state=indeterminate]:border-red-500 data-[state=indeterminate]:bg-red-500 data-[state=indeterminate]:text-white",
        "focus-visible:border-red-500 focus-visible:ring-2 focus-visible:ring-red-500/25",
