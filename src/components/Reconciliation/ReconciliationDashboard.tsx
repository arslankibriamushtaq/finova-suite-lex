    ...
    series: [
      {
        ...
        barWidth: '50%',
        data: [
          { value: 6000, itemStyle: { color: '#8D161C' } }, // IBFT - green
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ 
                ...
                <CheckCircleOutlined style={{ color: '#8D161C', fontSize: '18px' }} />
              </div>
              <div>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        <Col xs={24}>
          <Card
            ...
            bodyStyle={{ backgroundColor: 'white', borderRadius: '0 0 2px 2px' }}
          >
            <ReactECharts 
