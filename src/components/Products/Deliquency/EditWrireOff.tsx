...
const EditWriteOff: any = ({ productId, setSelectedTab }: any) => {
        ...
        .then((res) => {
          if (res.status == 200) {
            if (res.data.notificationMessage == "Operation successful.") {
              setFormValues({
                fromDay: res?.data?.data?.delinquency[4].fromDay,
                tillDay: res?.data?.data?.delinquency[4].tillDay,
                penalty: res?.data?.data?.delinquency[4].penaltyAmount
                  ? res?.data?.data?.delinquency[4].penaltyAmount
                  : res?.data?.data?.delinquency[4].penaltyPercentage,
              });
              setradioInputValue(
