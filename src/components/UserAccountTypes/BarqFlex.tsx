...
import { allCustomerStatusChange, getBarqFlexAccounts } from "../../redux/apis/apisCrud";
...
const BarqFlex = () => {
  ...
  const mappedData =
    ...
    const exportToExcel = () => {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "BarqFlex");
      XLSX.writeFile(workbook, "BarqFlex.xlsx");
    };
